const qBank = [{
    ...
    },
    {
        ...
        answer: "B. Keys are used internally to optimize rendering by reconciling children in Arrays."
    },
    {
        id: 3,
        ...
        answer: "B. An internal data store of a component that can change over time."
    },
    {
        id: 4,
        question: "Which lifecycle method is called when a component is first mounted in React?",
        options: [
            "A. componentDidMount",
    ...
    {
        id: 5,
        question: "What can you use to handle side effects in functional components in React?",
        options: [
            "A. useState",
            "B. useReducer",
            "C. useEffect",
